...
from src.data_extraction import load_data, main
...
class TestDataExtractionMain(unittest.TestCase):
    @patch("src.data_extraction.load_data")
    def test_main(self, mock_load_data):
        ...
        # Verify it called load_data with the default file
        mock_load_data.assert_called_with("dataset (1).csv")
